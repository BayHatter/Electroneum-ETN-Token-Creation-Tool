# Electroneum Token Creation Tool

A simple frontend tool to create tokens on the Electroneum (ETN) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Electroneum-ETN-Token-Creation-Tool.git
- And press deploy
- Congrats your Electroneum Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Electroneum-ETN-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Electroneum ETN wallet address for receiving fees. Also set fee in ETN that you want to charge
